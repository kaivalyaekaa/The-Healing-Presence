-- Seed data for The Healing Presence (H2-compatible)
-- Tables are created by JPA ddl-auto=update; this file inserts initial data.
...
-- ============================================================
-- FAQs (hypnotherapy-specific, ordered to match live therapy page)
-- ============================================================
